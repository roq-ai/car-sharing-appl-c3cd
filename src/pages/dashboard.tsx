...
import { useRoqPlatformUserProfiles, useCarCount, useReviewCount, useServiceCount } from 'lib/roq';

import { ServiceListPage as ShowCaseList } from 'pages/services';
...
function DashboardPage() {
  ...
  const serviceStat = useServiceCount();
